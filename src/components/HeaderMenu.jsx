                ...
                <nav className='p-2'>
                    ...
                    <div className="dropdown d-inline w-auto" >
                        ...
                        <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            <li> <NavLink className="dropdown-item" to="/antd-table"> Table </NavLink></li>
                            <li> <NavLink className="dropdown-item" to="/antd-table-product"> Table - Product </NavLink></li>
                        </ul>
                    </div>
                    <div className="dropdown d-inline w-auto ms-2" >
                        <button className="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                            Redux - Demo
                        </button>
                        <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            <li> <NavLink className="dropdown-item" to="/redux/change-number"> Change number </NavLink></li>
                            <li> <NavLink className="dropdown-item" to="/redux/change-fontsize"> Change font size </NavLink></li>
                        </ul>
                    </div>
                </nav>
                
                <NavLink to='/cart' className={(props) => props.isActive ? 'mx-2 bg-white text-dark p-3 text-decoration-none d-block mt-2' : ' d-block mt-2 mx-2 text-white link'} style={{textDecoration:'none'}}>
